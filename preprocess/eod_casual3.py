    ...
    def generate_feature(self, selected_tickers_fname, begin_date, opath,
        ...
        for stock_index, single_EOD in enumerate(self.data_EOD):
            ...
            for row in range(begin_date_row, selected_EOD.shape[0]):
                ...
                mov_aver_features[row][4] = selected_EOD[row][1]
                mov_aver_features[row][5] = selected_EOD[row][2]
                mov_aver_features[row][6] = selected_EOD[row][3]
                mov_aver_features[row][7] = selected_EOD[row][4]
            ...
            for row in range(begin_date_row, selected_EOD.shape[0]):
                ...
                features[cur_index - pad_begin][1:9] = mov_aver_features[
                    row]
