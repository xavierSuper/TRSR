    ...
    def generate_feature(self, selected_tickers_fname, begin_date, opath,
        ...
        trading_dates = np.genfromtxt(
            os.path.join(self.data_path, '..',
                         self.market_name + '_aver_line_dates_risk.csv'),
...
if __name__ == '__main__':
    ...
    processor.generate_feature(
        processor.market_name + '_tickers_qualify_dr-0.98_min-5_smooth_risk.csv',
        datetime.strptime('2013-05-21 00:00:00', processor.date_format),
